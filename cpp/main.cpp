...
int main(int argc, char *argv[]) {
	...
	string fnTrainTar = dirData + "/annotations/lv" + lv + "/9/" + fn_train_target;
	string fnTrainGrn = dirData + "/annotations/lv" + lv + "/9/" + fn_train_ground;
	...
	string fnTestTar = dirData + "/annotations/lv" + lv + "/9/" + fn_test_target;
	string fnTestGrn = dirData + "/annotations/lv" + lv + "/9/" + fn_test_ground;
